...
6. **llvm-mingw22.1.7_64_UCRT**：[llvm-mingw-20260602-ucrt-x86_64.zip](https://github.com/mstorsjo/llvm-mingw/releases/download/20260602/llvm-mingw-20260602-ucrt-x86_64.zip)
...
## Qt6.10.2 完整版本
1. Qt6.10.2 msvc2022_64
2. Qt6.10.2 MinGW1310_64               (使用Qt官方默认编译器版本)
3. Qt6.10.2 MinGW1520_64(UCRT)    
4. Qt6.10.2 LLVM-MinGW17.0.6(UCRT)     (使用Qt官方默认编译器版本)
5. Qt6.10.2 LLVM-MinGW21.1.8(UCRT)

## Qt6.10.2 RP版本
1. Qt6.10.2 msvc2022_64_RP
2. Qt6.10.2 MinGW1310_64_RP            (使用Qt官方默认编译器版本)
3. Qt6.10.2 MinGW1520_64_RP(UCRT)
4. Qt6.10.2 LLVM-MinGW17.0.6_RP(UCRT)  (使用Qt官方默认编译器版本)
5. Qt6.10.2 LLVM-MinGW21.1.8_RP(UCRT)

## Qt6.10.2 编译器
1. **msvc2022_64**：Visual Studio 2022 Developer Command Prompt v17.14.25
2. **mingw1310_64**：[13.1.0-202407240918mingw1310.7z](https://download.qt.io/online/qtsdkrepository/windows_x86/desktop/tools_mingw1310/qt.tools.win64_mingw1310/13.1.0-202407240918mingw1310.7z) (Qt官方默认编译器版本)
...
4. **llvm-mingw17.0.6_64_UCRT**：[17.0.6-202409091150llvm_mingw1706.7z](https://download.qt.io/online/qtsdkrepository/windows_x86/desktop/tools_llvm_mingw1706/qt.tools.win64_llvm_mingw1706/17.0.6-202409091150llvm_mingw1706.7z)  (Qt官方默认编译器版本)
5. **llvm-mingw21.1.8_64_UCRT**：[llvm-mingw-20251216-ucrt-x86_64.zip](https://github.com/mstorsjo/llvm-mingw/releases/download/20251216/llvm-mingw-20251216-ucrt-x86_64.zip)
...
5. Qt6.10.1 LLVM-MinGW21.1.6(UCRT)
...
5. Qt6.10.1 LLVM-MinGW21.1.6_RP(UCRT)
...
## Qt6.9.3 完整版本
1. Qt6.9.3 msvc2022_64
2. Qt6.9.3 MinGW1310_64               (使用Qt官方默认编译器版本)
3. Qt6.9.3 MinGW1520_64(UCRT)    
4. Qt6.9.3 LLVM-MinGW17.0.6(UCRT)     (使用Qt官方默认编译器版本)
5. Qt6.9.3 LLVM-MinGW21.1.2(UCRT)

## Qt6.9.3 RP版本
1. Qt6.9.3 msvc2022_64_RP
2. Qt6.9.3 MinGW1310_64_RP            (使用Qt官方默认编译器版本)
3. Qt6.9.3 MinGW1520_64_RP(UCRT)
4. Qt6.9.3 LLVM-MinGW17.0.6_RP(UCRT)  (使用Qt官方默认编译器版本)
5. Qt6.9.3 LLVM-MinGW21.1.2_RP(UCRT)
...
3. **mingw1520_64_UCRT**：[x86_64-15.2.0-release-posix-seh-ucrt-rt_v13-rev0.7z](https://github.com/niXman/mingw-builds-binaries/releases/download/15.2.0-rt_v13-rev0/x86_64-15.2.0-release-posix-seh-ucrt-rt_v13-rev0.7z)
4. **llvm-mingw17.0.6_64_UCRT**：[17.0.6-202409091150llvm_mingw1706.7z](https://download.qt.io/online/qtsdkrepository/windows_x86/desktop/tools_llvm_mingw1706/qt.tools.win64_llvm_mingw1706/17.0.6-202409091150llvm_mingw1706.7z)  (Qt官方默认编译器版本)
5. **llvm-mingw21.1.2_64_UCRT**：[llvm-mingw-20250924-ucrt-x86_64.zip](https://github.com/mstorsjo/llvm-mingw/releases/download/20250924/llvm-mingw-20250924-ucrt-x86_64.zip)
