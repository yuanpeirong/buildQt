...
:: 设置LLVM-MinGW版本代号
SET MinGW_VERSION=llvm-mingw22.1.8_64_UCRT_RP
...
mkdir build-qtbase
cd build-qtbase
call %SRC_qtbase%\configure.bat -static -static-runtime -release -nomake examples -prefix %INSTALL_DIR% -opensource -confirm-license -qt-libpng -qt-libjpeg -qt-zlib -qt-pcre -qt-freetype -schannel -opengl desktop -- -G Ninja -DQT_BUILD_SBOM=OFF -DQT_GENERATE_SBOM=OFF
