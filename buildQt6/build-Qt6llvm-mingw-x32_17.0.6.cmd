...
:: configure
call %SRC_QT%\configure.bat -static -static-runtime -release -platform win32-clang-g++ -prefix %INSTALL_DIR% -nomake examples -nomake tests -skip qtwebengine -opensource -confirm-license -qt-libpng -qt-libjpeg -qt-zlib -qt-pcre -qt-freetype -schannel
